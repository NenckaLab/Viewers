...
// Import new MR-specific protocols
import mrAxial from './hangingprotocols/mrAxial';
import mrSagittal from './hangingprotocols/mrSagittal';
import mrCoronal from './hangingprotocols/mrCoronal';
import mrMpr from './hangingprotocols/mrMpr';
import mrT1 from './hangingprotocols/mrT1';
import mrT2 from './hangingprotocols/mrT2';
import mrFlair from './hangingprotocols/mrFlair';
import mrMultiSequence from './hangingprotocols/mrMultiSequence';
import mrDwi from './hangingprotocols/mrDwi';
...
function getHangingProtocolModule() {
    return [{
        ...
        {
            name: mrMultiSequence.id,
            protocol: mrMultiSequence,
        },
        {
            name: mrDwi.id,
            protocol: mrDwi,
